...
$header += 				'<tr class="z1" >'
$header += 								'<td colspan="8" >'
$header += 								'Список действующих Операционных офисов '
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\05OperOffice.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-05_Список_Операционных_Офисов" 
# $FileName
