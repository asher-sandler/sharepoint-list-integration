...
$header += "<title>Список действующих ППКО кредитных организаций Обнинского региона по состоянию на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\35VSPObninsk_Opsr.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-35_ППКО_Обнинск_ОПСиР" 
# $FileName
