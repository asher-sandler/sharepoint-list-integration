...
$header += "<title>Список действующих Операционных офисов кредитных организаций Калужского региона по состоянию на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\16OperOfissKaluga_Opsr.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-16_Опер_офис_Калужс_рег_ОПСиР" 
# $FileName
