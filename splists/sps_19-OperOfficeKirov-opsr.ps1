...
$header += "<title>Список действующих Операционных офисов кредитных организаций Кировского региона по состоянию на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\19OperOfissKirov_Opsr.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-19_Опер_офис_Киров_ОПСиР" 
# $FileName
