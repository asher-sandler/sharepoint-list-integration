...
$header += 				'<tr class="z1" >'
$header += 								'<td colspan="8" >'
$header += 								'Список передвижных пунктов кассовых операций (ППКО) '
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\32VSP-PPKO.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-32_Список_ППКО" 
# $FileName
