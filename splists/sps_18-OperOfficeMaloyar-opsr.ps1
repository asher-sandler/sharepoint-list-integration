...
$header += "<title>Список действующих Операционных офисов кредитных организаций Малоярославецкого региона по состоянию на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\18OperOfissMaloyar_Opsr.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-18_Опер_офис_Малоярославец_ОПСиР" 
# $FileName
