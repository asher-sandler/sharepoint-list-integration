...
$header += "<title>Список дополнительных офисов действующих КО на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
$header += 				'<tr class="z1" >'
$header += 								'<td colspan="4" >'
$header += 								'Список дополнительных офисов действующих КО по '
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\09spisDopOffice_Opsr.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-09_Список_Дополнительных_офисов_ОПСиР" 
# $FileName
