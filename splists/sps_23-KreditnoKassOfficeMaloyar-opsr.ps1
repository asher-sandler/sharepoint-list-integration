...
$header += "<title>Список действующих Кредитно-Кассовых офисов кредитных организаций Малоярославецкого региона по состоянию на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\23KKofficeMaloyar_Opsr.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-23_Кред_касс_офис_Малояр_ОПСиР" 
# $FileName
