...
$header += "<title>Список действующих Кредитно-Кассовых офисов кредитных организаций Обнинского региона по состоянию на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\22KKofficeObninsk_Opsr.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-22_Кред_касс_офис_Обнинск_ОПСиР" 
# $FileName
