...
$header += "<title>Список действующих кредитных организаций и филиалов кредитных организаций Калужского региона по состоянию на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
$header += 								'кредитных организаций Калужского региона по '
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\29KOKaluga_Opsr.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-29_КО_Калуга_ОПСиР" 
# $FileName

$region_spr = GET-CONTENT f:\AdminDir\SpisokKO\spavochniki\kaluga_sprav.txt
$region_str  = ""
