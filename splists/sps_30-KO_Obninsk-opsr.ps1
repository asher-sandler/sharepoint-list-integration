...
$header += "<title>Список действующих кредитных организаций и филиалов кредитных организаций Обнинского региона по состоянию на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
$header += 								'кредитных организаций Обнинского региона по '
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\30KOObninsk_Opsr.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-30_КО_Обнинск_ОПСиР" 
# $FileName

$region_spr = GET-CONTENT f:\AdminDir\SpisokKO\spavochniki\obninsk_sprav.txt
$region_str  = ""
