...
$header += "<title>Список действующих ППКО кредитных организаций Кировского региона по состоянию на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\33VSPKirov_Opsr.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-33_ППКО_Киров_ОПСиР" 
# $FileName
