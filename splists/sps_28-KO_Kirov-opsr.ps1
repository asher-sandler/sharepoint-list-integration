...
$header += "<title>Список действующих кредитных организаций и филиалов кредитных организаций Кировского региона по состоянию на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\28KOKirov_Opsr.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-28_КО_Киров_ОПСиР" 
# $FileName
