...
$header += 				'<tr class="z1" >'
$header += 								'<td colspan="8" >'
$header += 								'Список действующих дополнительных офисов '
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\03spisOffice.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-03_Список_Доп_Офисов" 
# $FileName
