...
$header += "<title>Список действующих дополнительных офисов кредитных организаций Калужского региона по состоянию на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\25DopOfficeKaluga_Opsr.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-25_Доп_офис_Калуга_ОПСиР" 
# $FileName
