...
$header += "<title>Список действующих дополнительных офисов кредитных организаций Кировского региона по состоянию на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\24DopOfficeKirov_Opsr.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-24_Доп_офис_Киров_ОПСиР" 
# $FileName
