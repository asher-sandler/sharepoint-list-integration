...
$header += "<title>Список действующих Операционных офисов кредитных организаций Обнинского региона по состоянию на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\17OperOfissObninsk_Opsr.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-17_Опер_офис_Обнинск_ОПСиР" 
# $FileName
