##############################################################
# 
# Список филиалов КО формируется в виде HTML страницы
...
$header += "<title>Список филиалов действующих КО на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
$header += 								'Список филиалов действующих кредитных организаций по '
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\13spisFil.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-01B_Список_Филиалов" 
# $FileName
