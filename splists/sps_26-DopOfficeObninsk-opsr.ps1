...
$header += "<title>Список действующих дополнительных офисов кредитных организаций Обнинского региона по состоянию на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\26DopOfficeObninsk_Opsr.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-25_Доп_офис_Обнинск_ОПСиР" 
# $FileName
