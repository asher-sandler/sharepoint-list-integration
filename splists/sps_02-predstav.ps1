...
$header += 				'<tr class="z1" >'
$header += 								'<td colspan="7" >'
$header += 								'Список действующих представительств '
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\02spisPrestav.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-02_Список_Представительств" 
# $FileName
