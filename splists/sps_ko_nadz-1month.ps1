##############################################################
# 
# Список КомБанков формируется в виде HTML страницы
...
$header += "<title>Список действующих кредитных организаций на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
$header += 								'Список действующих кредитных организаций '
...
Start-Transcript ‘f:\AdminDir\SpisokKO\12spisKO.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-01A_Список_KO" 
# $FileName
