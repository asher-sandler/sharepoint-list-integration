...
$header += "<title>Список действующих ППКО кредитных организаций Калужского региона по состоянию на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\34VSPKaluga_Opsr.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-33_ППКО_Калуга_ОПСиР" 
# $FileName
