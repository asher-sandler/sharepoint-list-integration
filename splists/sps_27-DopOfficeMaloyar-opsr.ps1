...
$header += "<title>Список действующих дополнительных офисов кредитных организаций Малоярославецкого региона по состоянию на $dtToday</title>"
$header += "</head>"
$header += "<body>"
...
#-------------------------------------------------------------------------------------
Start-Transcript ‘f:\AdminDir\SpisokKO\27DopOfficeMaloyar_Opsr.log’ -force
...
$FileName += [String]$(Get-Date).Day+"-25_Доп_офис_Малояр_ОПСиР" 
# $FileName
